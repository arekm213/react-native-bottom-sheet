...
const config: Config = {
  ...
  projectName: 'react-native-bottom-sheet', // Usually your repo name.
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/software-mansion/react-native-bottom-sheet/tree/main/website/',
        },
        blog: false,
        theme: {
  ...
  themeConfig: {
    ...
    navbar: {
      title: 'React Native Bottom Sheet',
      logo: {
        alt: 'React Native Bottom Sheet Logo',
        src: 'img/logo.svg',
      },
      items: [
        {
        ...
        {
          href: 'https://github.com/software-mansion/react-native-bottom-sheet',
          label: 'GitHub',
          position: 'right',
        },
      ],
